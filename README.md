# RPA-in-Python - Manoj Kumar Arroju's Implementation

![alt text](https://github.com/kiddojazz/RPA-in-Python/blob/main/images/Robot.png)

Exploring Robotic Process Automation with Python, leveraging my experience in building efficient and automated solutions.
...
Hi! I'm Manoj Kumar Arroju, a Software Engineer with over 5 years of experience in building scalable and efficient applications.

I built this project to demonstrate the power of RPA in automating everyday tasks, leveraging my skills in Python and automation frameworks. My background in distributed systems and cloud infrastructure allows me to approach automation challenges with a focus on scalability and reliability.

Skills applied: Python, RPA Frameworks, Web Automation
...
In this implementation, I focused on showcasing the versatility of the `rpa` library for various automation tasks. For the web automation example, I chose to use XPath for element selection (`//*[@name="q"]`) because it provides a robust and flexible way to target specific elements on a webpage, even when the page structure changes. This aligns with my experience in building resilient and maintainable automation scripts.

## My Approach

When working with the UCI dataset download, I aimed for a simple and direct approach using `r.click()`. This method effectively simulates a user clicking the download link, making it easy to retrieve the data for further analysis or processing.

---
## 👨‍💻 Connect With Me

**Manoj Kumar Arroju** - Software Developer

[![GitHub](https://img.shields.io/badge/GitHub-100000?style=for-the-badge&logo=github&logoColor=white)](https://github.com/arrojumanoj)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/manoj-kumar-arroju)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:arrojumanoj1483@gmail.com)
